...
const itinerary = {
  overview: {
    ...
    summary:
      "A cultural day trip to explore Taichung's historical and cultural attractions, including visits to museums and local cuisine.",
  },
  dailyPlan: [
    {
      day: "1",
      ...
      activities: [
        {
          ...
          description:
            "Explore important works of art and exhibitions in Taiwan.",
        ...
        },
        {
          ...
          description:
            "Experience local cultural and creative products and exhibitions.",
...
const Content = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    const opt = {
      ...
      html2canvas: {
        scale: 2, // 提高解析度
        useCORS: true, // 允許跨域資源（如有圖片）
        letterRendering: true, // 改善文字渲染
        width: element.clientWidth, // 限制寬度
        windowWidth: element.scrollWidth, // 確保捕獲完整寬度
      },
      jsPDF: {
        unit: "mm",
        format: "a4",
      ...
      >
        ...
        >
          <ListItemButton onClick={handleClick}>
            ...
            <ListItemText
              primary={`Day ${itinerary.dailyPlan[0].day}: ${itinerary.dailyPlan[0].date}`}
            />
